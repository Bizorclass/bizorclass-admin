...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'subscription-plan', loadChildren: () => import('app/modules/admin/subscription-plan/subscription-plan.module').then(m => m.SubscriptionPlanModule)},
            ...
            {path: 'terms-conditions', loadChildren: () => import('app/modules/admin/terms-conditions/terms-conditions.module').then(m => m.TermsConditionsModule)},
            {path: 'how-to-use', loadChildren: () => import('app/modules/admin/how-to-use/how-to-use.module').then(m => m.HowToUseModule)},
            {path: 'help', loadChildren: () => import('app/modules/admin/help/help.module').then(m => m.HelpModule)},
            {path: 'transfer-teacher-request', loadChildren: () => import('app/modules/admin/transfer-teacher/transfer-teacher.module').then(m => m.TransferTeacherModule)},
